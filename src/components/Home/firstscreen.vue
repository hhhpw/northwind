    ...
    <div :class="$style['video-mask']" v-if="state.isShowVideo">
      <div :class="$style['video-container']">
        ...
        <iframe
          height="550"
          width="980"
          src="https://iframe.videodelivery.net/2d3c58d014427798ef143c01bc420295?preload=true&autoplay=true&poster=https%3A%2F%2Fvideodelivery.net%2F2d3c58d014427798ef143c01bc420295%2Fthumbnails%2Fthumbnail.jpg%3Ftime%3D%26height%3D600&controls=false"
          style="border: none"
