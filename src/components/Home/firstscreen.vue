    ...
    <div :class="$style['video-mask']" v-if="state.isShowVideo">
      <div :class="$style['video-container']">
        ...
        <iframe
          height="550"
          width="980"
          src="https://iframe.videodelivery.net/1a9089480eb3bee5da60ab607bbc3078?preload=true&loop=true&autoplay=true&poster=https%3A%2F%2Fvideodelivery.net%2F1a9089480eb3bee5da60ab607bbc3078%2Fthumbnails%2Fthumbnail.jpg%3Ftime%3D%26height%3D600"
          style="border: none"
